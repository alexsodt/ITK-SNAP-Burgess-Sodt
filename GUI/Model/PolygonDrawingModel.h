...
public:
  ...
  void SetSliceIndexValue(int value);
...
protected:
  ...
  SmartPtr<AbstractRangedIntProperty> m_SliceIndexModel; // AJS, which slice we're in.
  ...
  int m_curSlice; // AJS. the slice for which we are currently doing polygons.
  ...
  SavedSlicePolygons *m_allPolygons;
